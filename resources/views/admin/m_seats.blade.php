    ...
    <div class="card shadow mb-4">
         <!-- Card Header - Dropdown -->
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <a href="{{ url('/dashboard/addnewseats') }}" class="btn btn-primary">Add New Seats</a>
            </div>
        <div class="card-body">
                ...
                <tbody>
                    @foreach ($meja as $seats)
                        <tr>
                            ...
                            <td>{{ $seats->no_meja }}</td>
                            <td>
                                <a href="{{ url('/dashboard/seats/delete/'.$seats->id) }}" class="btn btn-danger" onclick="return confirm('sure? you will delete data permanently.');">Delete</a>
                                @if ($seats->trashed())
                                    <a href="{{ url('/dashboard/seats/activate/'.$seats->id) }}" class="btn btn-primary" onclick="return confirm('sure? you will activate this data ?');">Activate</a>
                                @else
                                    <a href="{{ url('/dashboard/seats/deactivate/'.$seats->id) }}" class="btn btn-secondary" onclick="return confirm('sure? you will disable this data for temporary ?');">Disable</a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
