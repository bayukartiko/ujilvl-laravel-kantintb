...
@section('konten')
    ...
    <form method="POST" action="/agoods/add" enctype="multipart/form-data">
            ...
            <div class="card-body">
               ...
               @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="namamasakan" name="namamasakan" placeholder="Enter Food Name" value="{{ old('namamasakan') }}">
