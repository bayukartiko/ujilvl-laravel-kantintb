...
@section('sidebar')
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            ...
            <a class="collapse-item" href="cards.html">Seller</a>
            <a class="collapse-item" href="cards.html">Owner</a>
            </div>
        </div>
        </li>
        ...
        <!-- Topbar Navbar -->
            ...
            <!-- Nav Item - Alerts -->
                <li class="nav-item dropdown no-arrow mx-1">
                    ...
                    <a class="dropdown-item text-center small text-gray-500" href="#">Show All New Transactions</a>
                    </div>
                </li>
