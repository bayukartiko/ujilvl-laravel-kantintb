            ...
            <div class="card border-left-primary shadow h-100 py-2">
                ...
                <div class="card-footer">
                    <div class="h5 mb-0 font-weight-bold text-gray-800 d-flex">
                        <a href="{{ url('/kdashboard/profil') }}" class="btn btn-outline-primary">Change Profile</a>
                        &nbsp;|&nbsp;
                        <a href="{{ url('/kdashboard/password') }}" class="btn btn-outline-primary">Change Password</a>
                        &nbsp;|&nbsp;
