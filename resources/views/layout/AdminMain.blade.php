    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/adashboard') }}">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                aria-labelledby="userDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ url('/adashboard/profil') }}">
                                        <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                        Change Profile
                                    </a>
                                    <a class="dropdown-item" href="{{ url('/adashboard/password') }}">
