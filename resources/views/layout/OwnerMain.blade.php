    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Nav Item - Dashboard -->
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/odashboard') }}">
                ...
                <!-- Nav Item - Dashboard -->
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/oreport') }}">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                aria-labelledby="userDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ url('/odashboard/profil') }}">
                                        <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                        Change Profile
                                    </a>
                                    <a class="dropdown-item" href="{{ url('/odashboard/password') }}">
            ...
            $("#pilihan_report").on('change', function(){
                ...
                if($pilihan == "transaksi"){
                    ...
                    $("#chain1").html(
                        '<div class="hasil-c1">'+
                            '<br>'+
                            '<label for="pilihan_user" class="col-form-label">Select Users role</label>'+
                            '<select name="pilihan_user" id="pilihan_user" class="form-control" required>'+
                                '<option value="" selected disabled>> Select Users role <</option>'+
                                '<option value="all">All users role</option>'+
                                '<option value="admin">Admin role</option>'+
                                '<option value="waiter">Waiter role</option>'+
                                '<option value="kasir">Cashier role</option>'+
                                '<option value="owner">Owner role</option>'+
                            '</select>'+
                            '@if($errors->has("pilihan_user"))'+
                                '<div class="text-danger">'+
                                    '<small>{{ $errors->first("pilihan_user")}}</small>'+
                                '</div>'+
                            '@endif'+
                        '</div>'
                    );
                }else if($pilihan == "order"){
                    $("#chain1").html(
                        '<div class="hasil-c1">'+
                            '<br>'+
                ...
                }else if($pilihan == "meja"){
                    $("#chain1").html(
                        '<div class="hasil-c1">'+
                            '<br>'+
                            '<label for="pilihan_meja" class="col-form-label">Select seats status</label>'+
                            '<select name="pilihan_meja" id="pilihan_meja" class="form-control" required>'+
                                '<option value="" selected disabled>> Select seats status <</option>'+
                                '<option value="all">All seats</option>'+
                                '<option value="used">seats used</option>'+
                                '<option value="unused">seats unused</option>'+
                            '</select>'+
                            '@if($errors->has("pilihan_meja"))'+
                                '<div class="text-danger">'+
                                    '<small>{{ $errors->first("pilihan_meja")}}</small>'+
                                '</div>'+
                            '@endif'+
                        '</div>'
                    );
